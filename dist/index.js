...
var CallIcon = _interopDefault(require('@material-ui/icons/Call'));
...
function KeypadBlock(_ref) {
  var handleCallAttendedTransfer = _ref.handleCallAttendedTransfer,
      ...
      handleSettingsButton = _ref.handleSettingsButton,
  ...
  var inCall = activeChanel.inCall,
      ...
      autoMute = activeChanel.autoMute,
  ...
  }, hold ? /*#__PURE__*/React__default.createElement(icons.Pause, null) : /*#__PURE__*/React__default.createElement(icons.PlayArrow, null))))), /*#__PURE__*/React__default.createElement(core.Grid, {
    item: true,
    xs: 3
  }, /*#__PURE__*/React__default.createElement(core.Tooltip, {
    title: "Transfer Call",
  ...
  }, /*#__PURE__*/React__default.createElement(icons.Transform, null))))), inAnswerTransfer && !inConference && inTransfer && transferControl ? /*#__PURE__*/React__default.createElement(core.Grid, {
    container: true,
    spacing: 0,
    className: classes.gridRaw
  }, /*#__PURE__*/React__default.createElement(core.Grid, {
...
function TabPanel(props) {
  ...
  }, other), value === index && /*#__PURE__*/React__default.createElement(Box, {
    p: 3
  }, children));
}
...
function SwipeCaruselBlock(_ref) {
  ...
  displayCalls.map(function (displayCall, key) {
    ...
    if (displayCall.inCall === true && displayCall.inAnswer === true && intervals[key].active === false) {
      ...
      setintervals(function (intervals) {
        return _objectSpread2(_objectSpread2({}, intervals), {}, _defineProperty({}, key, {
          intrId: intr,
          active: true
        }));
      });
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(AppBar, {
    position: "static",
    color: "default"
    ...
    return /*#__PURE__*/React__default.createElement(TabPanel, {
      ...
      if (displayCall.inCall === true) {
        if (displayCall.inAnswer === true) {
          if (displayCall.hold === true) {
            return (
              /*#__PURE__*/
              // Show hold Call info
              React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Typography, null, "Status:", ' ', displayCall.callInfo), /*#__PURE__*/React__default.createElement(Typography, null, "Duração:", duration[key].duration), /*#__PURE__*/React__default.createElement(Typography, null, "Número:", displayCall.callNumber), /*#__PURE__*/React__default.createElement(Typography, null, "Direção:", displayCall.direction))
            );
          }
          ...
          if (displayCall.inTransfer === true) {
            return (
              ...
              React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Typography, null, "Status:", ' ', displayCall.callInfo), /*#__PURE__*/React__default.createElement(Typography, null, "Direção:", displayCall.direction), /*#__PURE__*/React__default.createElement(Typography, null, "Duração:", duration[key].duration), /*#__PURE__*/React__default.createElement(Typography, null, "Número:", ' ', displayCall.callNumber), /*#__PURE__*/React__default.createElement(Typography, null, "Transfer to :", ' ', displayCall.transferNumber), /*#__PURE__*/React__default.createElement(Typography, null, displayCall.attendedTransferOnline.length > 1 && !displayCall.inConference ? /*#__PURE__*/React__default.createElement("span", null, 'Talking with :', ' ', displayCall.attendedTransferOnline) : null))
            );
          }
          ...
          return (
            /*#__PURE__*/
            // Show In Call info
            React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Typography, null, "Status:", displayCall.callInfo), /*#__PURE__*/React__default.createElement(Typography, null, "Direção:", displayCall.direction), /*#__PURE__*/React__default.createElement(Typography, null, "Duração:", duration[key].duration), /*#__PURE__*/React__default.createElement(Typography, null, "Número:", displayCall.callNumber))
          );
        }
        ...
        return (
          /*#__PURE__*/
          // Show Calling info
          React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Typography, null, "Status:", ' ', displayCall.callInfo), /*#__PURE__*/React__default.createElement(Typography, null, "Direção:", ' ', displayCall.direction), /*#__PURE__*/React__default.createElement(Typography, null, "Número:", ' ', displayCall.callNumber))
        );
      }
      ...
      return (
        /*#__PURE__*/
        // Show Ready info
        React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Typography, null, "Status:", ' ', displayCall.callInfo, ' ', displayCall.info))
      );
    });
  })));
}
...
function SettingsBlock(_ref) {
  ...
  var callVolume = localStatePhone.callVolume,
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    item: true,
    xs: 3
  }, ringVolume === 0 ? /*#__PURE__*/React__default.createElement(icons.NotificationsOff, {
    ...
    value: ringVolume,
    onChange: handleSettingsSlider('ringVolume'),
    "aria-labelledby": "continuous-slider"
  })), /*#__PURE__*/React__default.createElement(core.Grid, {
    item: true,
    xs: 3
  }, callVolume === 0 ? /*#__PURE__*/React__default.createElement(icons.VolumeOff, {
    className: classes.sliderIcons
    ...
    value: callVolume,
    onChange: handleSettingsSlider('callVolume'),
    "aria-labelledby": "continuous-slider"
...
function CallQueue(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, "Answer"))), /*#__PURE__*/React__default.createElement(core.Grid, {
      item: true,
      xs: 6
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classes.paper
...
function CallsFlowControl() {
  ...
  this.unhold = function (sessionId) {
    ...
    if (!_this.activeCall) {
      ...
      var toUnhold = lodash.find(_this.holdCallsQueue, {
        id: sessionId
  ...
  this.removeCallFromQueue = function (callId) {
    lodash.remove(_this.callsQueue, function (calls) {
  ...
  this.removeCallFromHoldQueue = function (callId) {
    lodash.remove(_this.holdCallsQueue, function (calls) {
      return calls.id === callId;
    });
  };
  ...
  this.sessionEvent = function (type, data, cause, callId) {
    ...
    switch (type) {
      ...
      case 'unhold':
        ...
        _this.activeCall = lodash.find(_this.holdCallsQueue, {
          id: callId
        });
      ...
      case 'confirmed':
        if (!_this.activeCall) {
          _this.activeCall = lodash.find(_this.callsQueue, {
            id: callId
          });
        }
  ...
  this.handleNewRTCSession = function (rtcPayload) {
    ...
    lodash.forEach(defaultCallEventsToHandle, function (eventType) {
  ...
  this.init = function () {
    ...
    lodash.forEach(binds, function (value) {
...
function SoftPhone(_ref) {
  var callVolume = _ref.callVolume,
      ...
      connectOnStart = _ref$connectOnStart === void 0 ? false : _ref$connectOnStart,
      config = _ref.config;
  ...
  flowRoute.onCallActionConnection = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, payload, data) {
      var newProgressLocalStatePhone, displayCallId, acceptedCall, newAcceptedLocalStatePhone, newAcceptedPhoneCalls;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.t0 = type;
              _context.next = _context.t0 === 'reinvite' ? 3 : _context.t0 === 'incomingCall' ? 5 : _context.t0 === 'outgoingCall' ? 7 : _context.t0 === 'callEnded' ? 11 : _context.t0 === 'callAccepted' ? 13 : _context.t0 === 'hold' ? 20 : _context.t0 === 'unhold' ? 22 : _context.t0 === 'unmute' ? 24 : _context.t0 === 'mute' ? 26 : _context.t0 === 'notify' ? 28 : 30;
              break;
            ...
            case 3:
              ...
              setLocalStatePhone(function (prevState) {
                return _objectSpread2(_objectSpread2({}, prevState), {}, {
                  displayCalls: lodash.map(localStatePhone.displayCalls, function (a) {
              ...
              setLocalStatePhone(function (prevState) {
                return _objectSpread2(_objectSpread2({}, prevState), {}, {
                  phoneCalls: [].concat(_toConsumableArray(prevState.phoneCalls), [{
                    callNumber: payload.remote_identity.display_name !== '' ? "".concat(payload.remote_identity.display_name || '', "__").concat(payload.remote_identity.uri.user, "__") : payload.remote_identity.uri.user,
            ...
            case 7:
              ...
              newProgressLocalStatePhone = lodash.cloneDeep(localStatePhone);
            ...
            case 13:
              ...
              newAcceptedLocalStatePhone = lodash.cloneDeep(localStatePhone); // Lets check and delete the call from  phone calls list
  ...
  var handleSettingsSlider = function handleSettingsSlider(name) {
    return function (e, newValue) {
      ...
      switch (name) {
        case 'ringVolume':
          ringer.current.volume = parseInt(newValue, 10) / 100; // flowRoute.setOutputVolume(newValue);
  ...
  var handleCallTransfer = function handleCallTransfer() {
    var newCallTransferDisplayCalls = lodash.map(localStatePhone.displayCalls, function (a) {
    ...
    flowRoute.activeCall.sendDTMF("##".concat(dialState));
  };

  var handleCallAttendedTransfer = function handleCallAttendedTransfer(event) {
    switch (event) {
      case 'transfer':
        setLocalStatePhone(function (prevState) {
          return _objectSpread2(_objectSpread2({}, prevState), {}, {
        ...
        flowRoute.activeCall.sendDTMF("*2".concat(dialState));
        break;

      case 'merge':
        var newCallMergeAttendedTransferDisplayCalls = lodash.map(localStatePhone.displayCalls, function (a) {
          return a.id === activeChannel ? _objectSpread2(_objectSpread2({}, a), {}, {
            callInfo: 'Conference',
            inConference: true
          }) : a;
      ...
      case 'cancel':
        var newCallCancelAttendedTransferDisplayCalls = lodash.map(localStatePhone.displayCalls, function (a) {
          return a.id === activeChannel ? _objectSpread2(_objectSpread2({}, a), {}, {
            transferNumber: dialState,
            allowAttendedTransfer: true,
            allowTransfer: true,
  ...
  }, /*#__PURE__*/React__default.createElement(CallIcon, null))), /*#__PURE__*/React__default.createElement(core.Drawer, {
  ...
  }, classes.direction === 'ltr' ? /*#__PURE__*/React__default.createElement(ChevronLeftIcon, null) : /*#__PURE__*/React__default.createElement(ChevronRightIcon, null))), /*#__PURE__*/React__default.createElement(core.Snackbar, {
  ...
  })), /*#__PURE__*/React__default.createElement(core.Divider, null), /*#__PURE__*/React__default.createElement(SettingsBlock, {
    localStatePhone: localStatePhone,
